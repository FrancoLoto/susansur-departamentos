        ...
        <>
            <div className="bg-primario">
                <div className="flex flex-col items-center justify-center pt-10 pb-20">
                    ...
                    <div>
                        <a href="https://www.meteoblue.com/es/tiempo/semana/las-grutas_argentina_7646573?utm_source=weather_widget&utm_medium=linkus&utm_content=daily&utm_campaign=Weather%2BWidget" target="_blank" rel="noreferrer">meteoblue</a>
                    </div>
                </div>
            </div>
        </>
